...
class list_account_records_response final :
 ...
 public:
  ...
  public:
  void clear_record();
  ::tutorial::list_account_records_response_account_record* mutable_record(int index);
  ::PROTOBUF_NAMESPACE_ID::RepeatedPtrField< ::tutorial::list_account_records_response_account_record >*
      mutable_record();
  private:
  const ::tutorial::list_account_records_response_account_record& _internal_record(int index) const;
  ::tutorial::list_account_records_response_account_record* _internal_add_record();
  public:
  const ::tutorial::list_account_records_response_account_record& record(int index) const;
  ::tutorial::list_account_records_response_account_record* add_record();
 ...
 private:
  ...
  struct Impl_ {
    ::PROTOBUF_NAMESPACE_ID::internal::HasBits<1> _has_bits_;
    mutable ::PROTOBUF_NAMESPACE_ID::internal::CachedSize _cached_size_;
    ::PROTOBUF_NAMESPACE_ID::RepeatedPtrField< ::tutorial::list_account_records_response_account_record > record_;
    ::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr desc_;
    int32_t code_;
  };
  union { Impl_ _impl_; };
...
class list_travel_records_response final :
 ...
 public:
  ...
  public:
  void clear_records();
  const ::tutorial::list_travel_records_response_travel_record& records() const;
  PROTOBUF_NODISCARD ::tutorial::list_travel_records_response_travel_record* release_records();
  ::tutorial::list_travel_records_response_travel_record* mutable_records();
  void set_allocated_records(::tutorial::list_travel_records_response_travel_record* records);
  private:
  const ::tutorial::list_travel_records_response_travel_record& _internal_records() const;
  ::tutorial::list_travel_records_response_travel_record* _internal_mutable_records();
  public:
  void unsafe_arena_set_allocated_records(
      ::tutorial::list_travel_records_response_travel_record* records);
  ::tutorial::list_travel_records_response_travel_record* unsafe_arena_release_records();
 ...
 private:
  ...
  struct Impl_ {
    ...
    mutable ::PROTOBUF_NAMESPACE_ID::internal::CachedSize _cached_size_;
    ::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr desc_;
    ::tutorial::list_travel_records_response_travel_record* records_;
    double mileage_;
    double discharge_;
    double calorie_;
    int32_t code_;
...
// repeated .tutorial.list_account_records_response.account_record record = 3;
inline int list_account_records_response::_internal_record_size() const {
  return _impl_.record_.size();
}
inline int list_account_records_response::record_size() const {
  return _internal_record_size();
}
inline void list_account_records_response::clear_record() {
  _impl_.record_.Clear();
}
inline ::tutorial::list_account_records_response_account_record* list_account_records_response::mutable_record(int index) {
  // @@protoc_insertion_point(field_mutable:tutorial.list_account_records_response.record)
...
list_account_records_response::mutable_record() {
  // @@protoc_insertion_point(field_mutable_list:tutorial.list_account_records_response.record)
  return &_impl_.record_;
}
inline const ::tutorial::list_account_records_response_account_record& list_account_records_response::_internal_record(int index) const {
  return _impl_.record_.Get(index);
}
inline const ::tutorial::list_account_records_response_account_record& list_account_records_response::record(int index) const {
  // @@protoc_insertion_point(field_get:tutorial.list_account_records_response.record)
  return _internal_record(index);
}
inline ::tutorial::list_account_records_response_account_record* list_account_records_response::_internal_add_record() {
  return _impl_.record_.Add();
}
inline ::tutorial::list_account_records_response_account_record* list_account_records_response::add_record() {
  ::tutorial::list_account_records_response_account_record* _add = _internal_add_record();
  // @@protoc_insertion_point(field_add:tutorial.list_account_records_response.record)
  return _add;
}
inline const ::PROTOBUF_NAMESPACE_ID::RepeatedPtrField< ::tutorial::list_account_records_response_account_record >&
list_account_records_response::record() const {
  // @@protoc_insertion_point(field_list:tutorial.list_account_records_response.record)
  return _impl_.record_;
}
...
// required .tutorial.list_travel_records_response.travel_record records = 6;
inline bool list_travel_records_response::_internal_has_records() const {
  bool value = (_impl_._has_bits_[0] & 0x00000002u) != 0;
  PROTOBUF_ASSUME(!value || _impl_.records_ != nullptr);
  return value;
}
inline bool list_travel_records_response::has_records() const {
...
inline const ::tutorial::list_travel_records_response_travel_record& list_travel_records_response::_internal_records() const {
  const ::tutorial::list_travel_records_response_travel_record* p = _impl_.records_;
  return p != nullptr ? *p : reinterpret_cast<const ::tutorial::list_travel_records_response_travel_record&>(
      ::tutorial::_list_travel_records_response_travel_record_default_instance_);
}
inline const ::tutorial::list_travel_records_response_travel_record& list_travel_records_response::records() const {
  // @@protoc_insertion_point(field_get:tutorial.list_travel_records_response.records)
  return _internal_records();
}
inline void list_travel_records_response::unsafe_arena_set_allocated_records(
    ::tutorial::list_travel_records_response_travel_record* records) {
  ...
  // @@protoc_insertion_point(field_unsafe_arena_set_allocated:tutorial.list_travel_records_response.records)
}
inline ::tutorial::list_travel_records_response_travel_record* list_travel_records_response::release_records() {
  _impl_._has_bits_[0] &= ~0x00000002u;
  ::tutorial::list_travel_records_response_travel_record* temp = _impl_.records_;
...
inline ::tutorial::list_travel_records_response_travel_record* list_travel_records_response::unsafe_arena_release_records() {
  // @@protoc_insertion_point(field_release:tutorial.list_travel_records_response.records)
  _impl_._has_bits_[0] &= ~0x00000002u;
  ::tutorial::list_travel_records_response_travel_record* temp = _impl_.records_;
  _impl_.records_ = nullptr;
  return temp;
}
inline ::tutorial::list_travel_records_response_travel_record* list_travel_records_response::_internal_mutable_records() {
  _impl_._has_bits_[0] |= 0x00000002u;
  if (_impl_.records_ == nullptr) {
    auto* p = CreateMaybeMessage<::tutorial::list_travel_records_response_travel_record>(GetArenaForAllocation());
    _impl_.records_ = p;
  }
  return _impl_.records_;
}
inline ::tutorial::list_travel_records_response_travel_record* list_travel_records_response::mutable_records() {
  ::tutorial::list_travel_records_response_travel_record* _msg = _internal_mutable_records();
  // @@protoc_insertion_point(field_mutable:tutorial.list_travel_records_response.records)
  return _msg;
}
inline void list_travel_records_response::set_allocated_records(::tutorial::list_travel_records_response_travel_record* records) {
  ...
  _impl_.records_ = records;
  // @@protoc_insertion_point(field_set_allocated:tutorial.list_travel_records_response.records)
}
