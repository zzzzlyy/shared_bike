...
bool NetworkInterface::start(int port)
{
	...
	//启动监听，设置回调（NetworkInterface::listener_cb）
...
void NetworkInterface::handle_request(struct bufferevent* bev, void* arg)
{
	...
	if (cs->req_stat == MESSAGE_STATUS::MS_READ_HEADER)//读取头部数据
	{
